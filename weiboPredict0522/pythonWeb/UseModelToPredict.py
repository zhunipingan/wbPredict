...
# dataframe = lda.do_test_LDA(dataframe,num_topics = 5)
...
for i in range(len(target)):
    ...
    model_name = "modelrf"+str(i)+"train_model0410 5.m" #0403_2rf
...
res_dataframe.to_sql('predict_weibo_result_0410_5',insert_conn,if_exists='replace',index = False)
