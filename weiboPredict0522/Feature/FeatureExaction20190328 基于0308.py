...
weibo_train_data.to_csv('../data/weibo_train_data_0329.csv', index=False)
...
weibo_predict_data.to_csv('../data/weibo_predict_data_0329.csv', index=False)
...
# make_feature(1)
result.to_csv(r'D:\graduation project\weiboPredict\result_0329.csv')

text = open('D:\graduation project\weiboPredict\out0329.txt', 'w')
i = 0
