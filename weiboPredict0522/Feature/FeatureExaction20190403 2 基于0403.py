...
weibo_train_data.to_csv('../data/weibo_train_data_0403_2rf.csv', index=False)
...
weibo_predict_data.to_csv('../data/weibo_predict_data_0403_2rf.csv', index=False)
...
for i in range(len(target)):
    ...
    score = cross_val_score(rf, weibo_train_data[predictors], weibo_train_data[target[i]], cv=5)
    ...
    print("Model save...")
    model_name = "rf"+str(i)+"train_model0403_2rf.m"
...
train_result.to_csv(r'D:\graduation project\weiboPredict\train_result0403_2rf.csv')
...
train_result.to_sql('predict_weibo_result2',insert_conn,if_exists='replace',index = False)
print('保存训练对比数据完成')
...
# make_feature(1)
result.to_csv(r'D:\graduation project\weiboPredict\result_0403_2rf.csv')

text = open('D:\graduation project\weiboPredict\out0403_2rf.txt', 'w')
i = 0
