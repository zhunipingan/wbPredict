...
weibo_train_data.to_csv('../data/weibo_train_data_0321.csv', index=False)
...
weibo_predict_data.to_csv('../data/weibo_predict_data_0321.csv', index=False)
...
dropped_train_dataset = ['uid', 'mid', 'time', 'date', 'sum_interact', 'level_interact','content','content_no_stopwords_list']
dropped_predict_datastet = ['uid', 'mid', 'time', 'date','content','content_no_stopwords_list']
...
weibo_predict_data = weibo_predict_data.append(weibo_predict_data_old,sort=False)
result = weibo_predict_data.loc[:, ['mid', 'uid', 'forward_count', 'comment_count', 'like_count']]
# make_feature(1)
result.to_csv(r'D:\graduation project\weiboPredict\result_0321.csv')

text = open('D:\graduation project\weiboPredict\out0321.txt', 'w')
i = 0
