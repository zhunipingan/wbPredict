...
class TextLSTM(object):
    def __init__(self,config):
        ...
        self.input_x=tf.placeholder(tf.float32,[None,self.num_steps,self.hidden_size],name="input_x") # hidden_size基本就是样本数量，num_steps是句子长度
        ...
        with tf.variable_scope("Net",initializer=tf.orthogonal_initializer()):
            ...
            attn_cell = lstm_cell #不带括号时，调用的是这个函数本身 ，是整个函数体，是一个函数对象，不须等该函数执行完成
            ...
            #转置shape: (batch_size, num_steps,hidden_size) => (num_steps,batch_size,hidden_size)
