...
weibo_train_data.to_csv('../data/weibo_train_data_0403rf.csv', index=False)
...
weibo_predict_data.to_csv('../data/weibo_predict_data_0403rf.csv', index=False)
...
for i in range(len(target)):
    ...
    print("Model save...")
    model_name = "rf"+str(i)+"train_model0403rf.m"
...
train_result.to_csv(r'D:\graduation project\weiboPredict\train_result0403rf.csv')
print('保存训练对比数据完成')
...
# make_feature(1)
result.to_csv(r'D:\graduation project\weiboPredict\result_0403rf.csv')

text = open('D:\graduation project\weiboPredict\out0403rf.txt', 'w')
i = 0
